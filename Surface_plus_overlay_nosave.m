function Surf = Surface_plus_overlay_nosave(SurfFile, ChFiles, plotopts);
%
% Syntax :
% OutFigures = Surface_plus_overlay_nosave(SurfFile, ChFile, OutDir);
%
...
for k = 1:size(ChFiles,1)
    ...
    elseif strcmp(hemi,'rh')
        ...
        % ----------- Plotting Surface  --------------------------------------%
        colordef black;hf = figure('numbertitle','off','Color','black','Position',[0 0 1200 900]);
        custom_plotsurf(Surf);
