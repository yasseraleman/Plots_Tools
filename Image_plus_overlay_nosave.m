function OutFigures = Image_plus_overlay_nosave(InputImage,OverlayImage,slices, plotopts);
%
% Syntax :
...
% Version $1.0
% 
 % InputImage = '/media/Data/PROCESSING_RESULTS/5-freesurfer_processing/Erick_0001/tmp/sdti_fa.nii';
%  InputImage = '/media/Data/PROCESSING_RESULTS/ASPERGER/5-freesurfer_processing/ASPER_00001__101-20060510/tmp/tT1t.nii'
%OverlayImage = '/media/Data/PROCESSING_RESULTS/5-freesurfer_processing/Erick_0001/tmp/sdti_v1_version1.nii'
...
%  slices = [0 60 0];
% 
% OverlayImage = strvcat('/media/Data/PROCESSING_RESULTS/ASPERGER/7-connectome/ASPER_00001__101-20060510/dtreconst/fsl/ASPER_00001__101-20060510_odf.nii',...
% '/media/Data/PROCESSING_RESULTS/ASPERGER/7-connectome/ASPER_00001__101-20060510/dtreconst/fsl/ASPER_00001__101-20060510_odfdirs.txt',...
% '/media/Data/PROCESSING_RESULTS/ASPERGER/7-connectome/ASPER_00001__101-20060510/dtreconst/fsl/ASPER_00001__101-20060510_odffaces.txt');
...
if nargin < 4
    ...
    plotopts.dtype.modul = 1;
    plotopts.linelength = 1/2;
%           plotopts.lims.Xlim = [54 60];
%           plotopts.lims.Ylim = [78 90];
        ...
        if length(VO) == 1 % Verifying if the image is Coloured or not
            ...
            if length(sts)==1
                ...
                switch plotopts.itype
                    case 'image'
                        ind = find(abs(IOs)<10^6*eps);IOs(ind) = 0;
            ...
            if  length(VO) == 3
                ...
                switch  plotopts.dtype.type
                    ...
                    case 'vectorial'
                        ...
                        It = squeeze(IOs(:,:,3));
                        drawev(:,3) = It(indd);
                         drawev(:,1:2) = -1*drawev(:,1:2);% 180 degrees rotation around X axis
